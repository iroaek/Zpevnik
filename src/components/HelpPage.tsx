  ...
  return (
    <section className="info-page help-page" aria-labelledby="help-heading">
      ...
      <div className="help-steps">
        ...
        <article><span>3</span><div><h2>Stáhněte písně offline</h2><p>Před cestou otevřete Offline obsah. Schválený uživatel zde stáhne nebo obnoví soukromou knihovnu; ukázky a noty se spravují samostatně.</p><button type="button" className="text-button" onClick={() => onNavigate('offline')}>Otevřít Offline obsah</button></div></article>
        ...
        <article><span>7</span><div><h2>Uvolněte místo</h2><p>Na obrazovce Offline obsah lze odstranit jednu staženou píseň, celou členskou knihovnu, jen noty nebo veškerý stažený obsah. Oblíbené, setlisty a vlastní PDF importy tím nezmizí.</p></div></article>
      </div>
    </section>
  );
}
