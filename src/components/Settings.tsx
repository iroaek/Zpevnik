  ...
  return (
    <section className="settings-page" aria-labelledby="settings-heading">
      ...
      <div className="settings-grid">
        ...
        <label>Pohyb a animace<select value={settings.motion} onChange={(event) => update({ motion: event.target.value as UserState['settings']['motion'] })}><option value="gentle">Jemné 3D – doporučeno</option><option value="full">Filmové 3D</option><option value="off">Bez animací</option></select></label>
