...
function ChordDiagram({ chord, sourceNotation }: { chord: string; sourceNotation: ChordNotation }) {
  ...
  return <div className="chord-diagrams">
    <figure><figcaption>Kytara{baseFret > 1 ? ` · ${baseFret}. pražec` : ''}</figcaption><svg viewBox="0 0 150 128" role="img" aria-label={`Kytarový hmat ${chord}`}>
